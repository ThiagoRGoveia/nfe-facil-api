...
# Script to generate the UserCreditsLib and move original source files.

# Exit on any error
set -e

LIB_NAME="UserCreditsLib"
LIB_PREFIX="defaultLibraryPrefix"
SOURCE_MODULE_DIR="apps/api/src/core/user-credits"
...
echo "   - Examine '${MIGRATED_SOURCE_SUBDIR}/user-credits.module.ts' (if it existed)."
