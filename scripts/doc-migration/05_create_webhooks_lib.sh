...
# Script to generate the WebhooksLib and move original source files.

# Exit on any error
set -e

LIB_NAME="WebhooksLib"
LIB_PREFIX="defaultLibraryPrefix"
SOURCE_MODULE_DIR="apps/api/src/core/webhooks"
...
echo "   - Examine '${MIGRATED_SOURCE_SUBDIR}/webhooks.module.ts' (if it existed)."
