...
# Script to generate the TemplatesLib and move original source files.

# Exit on any error
set -e

LIB_NAME="TemplatesLib"
LIB_PREFIX="defaultLibraryPrefix"
SOURCE_MODULE_DIR="apps/api/src/core/templates"
...
echo "   - Examine '${MIGRATED_SOURCE_SUBDIR}/templates.module.ts' (if it existed)."
